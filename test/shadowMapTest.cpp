...
public:
    ...
    void initialize() override
    {
        ...
        m_meshPlane = Mesh::create().withQuad(2).build();
    ...
    // updates the shadow map ViewProjection matrix，shadowMapFraction:amount of view frustum with shadowmap
    ...
    {
        rp.draw(m_drawSphere ? m_meshSphere : m_mesh, glm::rotate(0.0f, glm::vec3(1, 0, 0)) * glm::rotate(0.0f, glm::vec3(0, 1, 0)), mat);
    ...
    void updateShadowMap()
    {
        m_shadowMapTexture = Texture::create()
                                 ...
                                 .withDepth(m_shadowMapSize, m_shadowMapSize, Texture::DepthPrecision::I24)
                                 .build();
