...
\label{shader_8h_source}\index{/Users/cwb/developer/learning/simpleRenderEngine/re/core/shader.h@{/Users/cwb/developer/learning/simpleRenderEngine/re/core/shader.h}}
...
\DoxyCodeLine{\Hypertarget{shader_8h_source_l00005}00005 \textcolor{preprocessor}{\#ifndef SIMPLERENDERENGINE\_SHADER\_H}}
\DoxyCodeLine{\Hypertarget{shader_8h_source_l00006}00006 \textcolor{preprocessor}{\#define SIMPLERENDERENGINE\_SHADER\_H}}
...
\DoxyCodeLine{\Hypertarget{shader_8h_source_l00019}00019 \textcolor{keyword}{namespace }\mbox{\hyperlink{namespacere}{re}}}
...
\DoxyCodeLine{\Hypertarget{shader_8h_source_l00025}\mbox{\hyperlink{classre_1_1_shader}{00025}} \textcolor{keyword}{class }\mbox{\hyperlink{classre_1_1_shader}{Shader}} : \textcolor{keyword}{public} std::enable\_shared\_from\_this<Shader>}
...
\DoxyCodeLine{\Hypertarget{shader_8h_source_l00044}00044         \mbox{\hyperlink{classre_1_1_texture}{Texture}},}
...
\DoxyCodeLine{\Hypertarget{shader_8h_source_l00056}\mbox{\hyperlink{structre_1_1_shader_1_1_uniform}{00056}}     \textcolor{keyword}{struct }\mbox{\hyperlink{structre_1_1_shader_1_1_uniform}{Uniform}}}
\DoxyCodeLine{\Hypertarget{shader_8h_source_l00057}00057     \{}
\DoxyCodeLine{\Hypertarget{shader_8h_source_l00058}00058         \mbox{\hyperlink{structre_1_1_shader_1_1_uniform}{Uniform}}(\textcolor{keyword}{const} \textcolor{keywordtype}{char}* \_name, int32\_t \_location, UniformType \_type, int32\_t \_count) :}
\DoxyCodeLine{\Hypertarget{shader_8h_source_l00059}00059             name(\_name), id(\_location), type(\_type), arraySize(\_count) \{\}}
\DoxyCodeLine{\Hypertarget{shader_8h_source_l00060}00060         \mbox{\hyperlink{structre_1_1_shader_1_1_uniform}{Uniform}}() = \textcolor{keywordflow}{default};}
...
\DoxyCodeLine{\Hypertarget{shader_8h_source_l00068}\mbox{\hyperlink{structre_1_1_shader_1_1_shader_attribute}{00068}}     \textcolor{keyword}{struct }\mbox{\hyperlink{structre_1_1_shader_1_1_shader_attribute}{ShaderAttribute}}}
...
\DoxyCodeLine{\Hypertarget{shader_8h_source_l00090}\mbox{\hyperlink{structre_1_1_shader_1_1_resource}{00090}}     \textcolor{keyword}{struct }\mbox{\hyperlink{structre_1_1_shader_1_1_resource}{Resource}}}
...
\DoxyCodeLine{\Hypertarget{shader_8h_source_l00121}\mbox{\hyperlink{structre_1_1_shader_1_1_stencil_descriptor}{00121}}     \textcolor{keyword}{struct }\mbox{\hyperlink{structre_1_1_shader_1_1_stencil_descriptor}{StencilDescriptor}}}
...
\DoxyCodeLine{\Hypertarget{shader_8h_source_l00131}\mbox{\hyperlink{classre_1_1_shader_1_1_shader_builder}{00131}}     \textcolor{keyword}{class }\mbox{\hyperlink{classre_1_1_shader_1_1_shader_builder}{ShaderBuilder}}}
...
\DoxyCodeLine{\Hypertarget{shader_8h_source_l00134}00134         \mbox{\hyperlink{classre_1_1_shader_1_1_shader_builder}{ShaderBuilder}}(\textcolor{keyword}{const} \mbox{\hyperlink{classre_1_1_shader_1_1_shader_builder}{ShaderBuilder}}\&) = \textcolor{keywordflow}{default};}
...
\DoxyCodeLine{\Hypertarget{shader_8h_source_l00136}00136         \mbox{\hyperlink{classre_1_1_shader_1_1_shader_builder}{ShaderBuilder}}\& withSource(std::string\_view vertexShader, std::string\_view fragmentShader);}
\DoxyCodeLine{\Hypertarget{shader_8h_source_l00137}00137         \mbox{\hyperlink{classre_1_1_shader_1_1_shader_builder}{ShaderBuilder}}\& withSourceString(std::string\_view shaderSource, ShaderType shaderType);}
\DoxyCodeLine{\Hypertarget{shader_8h_source_l00138}00138         \mbox{\hyperlink{classre_1_1_shader_1_1_shader_builder}{ShaderBuilder}}\& withSourceFile(std::string\_view shaderFile, ShaderType shaderType);}
\DoxyCodeLine{\Hypertarget{shader_8h_source_l00139}00139         \mbox{\hyperlink{classre_1_1_shader_1_1_shader_builder}{ShaderBuilder}}\& withDepthTest(\textcolor{keywordtype}{bool} enable);}
\DoxyCodeLine{\Hypertarget{shader_8h_source_l00140}00140         \mbox{\hyperlink{classre_1_1_shader_1_1_shader_builder}{ShaderBuilder}}\& withDepthWrite(\textcolor{keywordtype}{bool} enable);}
\DoxyCodeLine{\Hypertarget{shader_8h_source_l00141}00141         \mbox{\hyperlink{classre_1_1_shader_1_1_shader_builder}{ShaderBuilder}}\& withColorWrite(glm::bvec4 enable);}
\DoxyCodeLine{\Hypertarget{shader_8h_source_l00142}00142         \mbox{\hyperlink{classre_1_1_shader_1_1_shader_builder}{ShaderBuilder}}\& withBlend(BlendType blendType);}
\DoxyCodeLine{\Hypertarget{shader_8h_source_l00143}00143         \mbox{\hyperlink{classre_1_1_shader_1_1_shader_builder}{ShaderBuilder}}\& withName(std::string\_view name);}
\DoxyCodeLine{\Hypertarget{shader_8h_source_l00144}00144         \mbox{\hyperlink{classre_1_1_shader_1_1_shader_builder}{ShaderBuilder}}\& withStencil(\mbox{\hyperlink{structre_1_1_shader_1_1_stencil_descriptor}{StencilDescriptor}} stencil);}
\DoxyCodeLine{\Hypertarget{shader_8h_source_l00145}00145         \mbox{\hyperlink{classre_1_1_shader_1_1_shader_builder}{ShaderBuilder}}\& withOffset(\textcolor{keywordtype}{float} factor, \textcolor{keywordtype}{float} units); \textcolor{comment}{// 设置用于计算深度值的缩放比例和单位}}
\DoxyCodeLine{\Hypertarget{shader_8h_source_l00146}00146         \mbox{\hyperlink{classre_1_1_shader_1_1_shader_builder}{ShaderBuilder}}\& withCullFace(CullFace face);}
...
\DoxyCodeLine{\Hypertarget{shader_8h_source_l00151}00151         \mbox{\hyperlink{classre_1_1_shader_1_1_shader_builder}{ShaderBuilder}}() = \textcolor{keywordflow}{default};}
\DoxyCodeLine{\Hypertarget{shader_8h_source_l00152}00152         \textcolor{keyword}{explicit} \mbox{\hyperlink{classre_1_1_shader_1_1_shader_builder}{ShaderBuilder}}(\mbox{\hyperlink{classre_1_1_shader}{Shader}}* shader);}
...
\DoxyCodeLine{\Hypertarget{shader_8h_source_l00161}00161         \mbox{\hyperlink{classre_1_1_shader}{Shader}}* updateShader\{ \textcolor{keyword}{nullptr} \};}
...
\DoxyCodeLine{\Hypertarget{shader_8h_source_l00163}00163         \mbox{\hyperlink{structre_1_1_shader_1_1_stencil_descriptor}{StencilDescriptor}} m\_stencil\{\};}
...
\DoxyCodeLine{\Hypertarget{shader_8h_source_l00166}00166         \textcolor{keyword}{friend} \textcolor{keyword}{class }\mbox{\hyperlink{classre_1_1_shader}{Shader}};}
...
\DoxyCodeLine{\Hypertarget{shader_8h_source_l00170}00170     \textcolor{keyword}{static} \mbox{\hyperlink{classre_1_1_shader_1_1_shader_builder}{ShaderBuilder}} create();}
\DoxyCodeLine{\Hypertarget{shader_8h_source_l00171}00171     \textcolor{comment}{// Must end with build()}}
\DoxyCodeLine{\Hypertarget{shader_8h_source_l00172}00172     \textcolor{keyword}{static} \mbox{\hyperlink{classre_1_1_shader_1_1_shader_builder}{ShaderBuilder}} update();}
...
\DoxyCodeLine{\Hypertarget{shader_8h_source_l00183}00183     \textcolor{keyword}{static} std::string getSource(\textcolor{keyword}{const} \mbox{\hyperlink{structre_1_1_shader_1_1_resource}{Resource}}\& resource);}
...
\DoxyCodeLine{\Hypertarget{shader_8h_source_l00186}00186     \mbox{\hyperlink{classre_1_1_shader}{\string~Shader}}();}
\DoxyCodeLine{\Hypertarget{shader_8h_source_l00187}00187     \mbox{\hyperlink{structre_1_1_shader_1_1_uniform}{Uniform}} getUniformType(std::string\_view name);}
...
\DoxyCodeLine{\Hypertarget{shader_8h_source_l00265}00265 \} \textcolor{comment}{// namespace re}}
\DoxyCodeLine{\Hypertarget{shader_8h_source_l00266}00266 }
\DoxyCodeLine{\Hypertarget{shader_8h_source_l00267}00267 \textcolor{preprocessor}{\#endif }\textcolor{comment}{// SIMPLERENDERENGINE\_SHADER\_H}}
