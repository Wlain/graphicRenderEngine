...
\item \mbox{\hyperlink{group__init_gae5952184a0db36e24d1de7805b8b0945}{glfw\+Get\+Version\+String}}
...
Calling any other function before successful initialization will cause a \mbox{\hyperlink{group__errors_ga2374ee02c177f12e1fa76ff3ed15e14a}{GLFW\+\_\+\+NOT\+\_\+\+INITIALIZED}} error.\hypertarget{intro_guide_intro_init_init}{}\doxysubsection{Initializing GLFW}\label{intro_guide_intro_init_init}
The library is initialized with \mbox{\hyperlink{group__init_gab41771f0215a2e0afb4cf1cf98082d40}{glfw\+Init}}, which returns {\ttfamily GLFW\+\_\+\+FALSE} if an error occurred.
...
@macos When the library is initialized the main menu and dock icon are created. These are not desirable for a command-\/line only program. The creation of the main menu and dock icon can be disabled with the \mbox{\hyperlink{group__init_ga71e0b4ce2f2696a84a9b8c5e12dc70cf}{GLFW\+\_\+\+COCOA\+\_\+\+MENUBAR}} init hint.\hypertarget{intro_guide_init_hints}{}\doxysubsection{Initialization hints}\label{intro_guide_init_hints}
...
{\bfseries{GLFW\+\_\+\+JOYSTICK\+\_\+\+HAT\+\_\+\+BUTTONS}} specifies whether to also expose joystick hats as buttons, for compatibility with earlier versions of GLFW that did not have \mbox{\hyperlink{group__input_gaf0f00897c4d010af7bd1aea1f6193e6f}{glfw\+Get\+Joystick\+Hats}}. Possible values are {\ttfamily GLFW\+\_\+\+TRUE} and {\ttfamily GLFW\+\_\+\+FALSE}.
...
\begin{DoxyParagraph}{}
The ANGLE platform type is specified via the {\ttfamily EGL\+\_\+\+ANGLE\+\_\+platform\+\_\+angle} extension. This extension is not used if this hint is {\ttfamily GLFW\+\_\+\+ANGLE\+\_\+\+PLATFORM\+\_\+\+TYPE\+\_\+\+NONE}, which is the default value.
\end{DoxyParagraph}
\hypertarget{intro_guide_init_hints_osx}{}\doxysubsubsection{mac\+OS specific init hints}\label{intro_guide_init_hints_osx}
...
\mbox{\hyperlink{group__init_gab937983147a3158d45f88fad7129d9f2}{GLFW\+\_\+\+COCOA\+\_\+\+CHDIR\+\_\+\+RESOURCES}}   &{\ttfamily GLFW\+\_\+\+TRUE}   &{\ttfamily GLFW\+\_\+\+TRUE} or {\ttfamily GLFW\+\_\+\+FALSE}    \\\cline{1-3}
\mbox{\hyperlink{group__init_ga71e0b4ce2f2696a84a9b8c5e12dc70cf}{GLFW\+\_\+\+COCOA\+\_\+\+MENUBAR}}   &{\ttfamily GLFW\+\_\+\+TRUE}   &{\ttfamily GLFW\+\_\+\+TRUE} or {\ttfamily GLFW\+\_\+\+FALSE}   \\\cline{1-3}
\end{longtabu}
\hypertarget{intro_guide_intro_init_terminate}{}\doxysubsection{Terminating GLFW}\label{intro_guide_intro_init_terminate}
Before your application exits, you should terminate the GLFW library if it has been initialized. This is done with \mbox{\hyperlink{group__init_gafd90e6fd4819ea9e22e5e739519a6504}{glfw\+Terminate}}.
...
If no error has occurred since the last call, \mbox{\hyperlink{group__errors_gafa30deee5db4d69c4c93d116ed87dbf4}{GLFW\+\_\+\+NO\+\_\+\+ERROR}} (zero) is returned. The error is cleared before the function returns.

The error code indicates the general category of the error. Some error codes, such as \mbox{\hyperlink{group__errors_ga2374ee02c177f12e1fa76ff3ed15e14a}{GLFW\+\_\+\+NOT\+\_\+\+INITIALIZED}} has only a single meaning, whereas others like \mbox{\hyperlink{group__errors_gad44162d78100ea5e87cdd38426b8c7a1}{GLFW\+\_\+\+PLATFORM\+\_\+\+ERROR}} are used for many different errors.
...
\item \mbox{\hyperlink{group__vulkan_gada152edc5bbbd0c2138728878632fd9c}{glfw\+Get\+Required\+Instance\+Extensions}}
...
The run-\/time version can be retrieved with \mbox{\hyperlink{group__init_ga2402c7824ac0194c13722790ff9559ff}{glfw\+Get\+Version}}, a function that may be called regardless of whether GLFW is initialized.
...
The version string is returned by \mbox{\hyperlink{group__init_gae5952184a0db36e24d1de7805b8b0945}{glfw\+Get\+Version\+String}}, a function that may be called regardless of whether GLFW is initialized.

{\bfseries{Do not use the version string}} to parse the GLFW library version. The \mbox{\hyperlink{group__init_ga2402c7824ac0194c13722790ff9559ff}{glfw\+Get\+Version}} function already provides the version of the running library binary.
