...
\label{mesh_8cpp_source}\index{/Users/cwb/developer/learning/graphicRenderEngine/ceres/core/mesh.cpp@{/Users/cwb/developer/learning/graphicRenderEngine/ceres/core/mesh.cpp}}
...
\DoxyCodeLine{\Hypertarget{mesh_8cpp_source_l00015}00015 \textcolor{keyword}{namespace }ceres}
...
\DoxyCodeLine{\Hypertarget{mesh_8cpp_source_l00024}00024         \textcolor{keywordflow}{throw} std::runtime\_error(\textcolor{stringliteral}{"{}Cannot instantiate re::Mesh before ceres::Renderer is created."{}});}
...
\DoxyCodeLine{\Hypertarget{mesh_8cpp_source_l00196}00196     builder.m\_mesh = \textcolor{keyword}{this};}
...
\DoxyCodeLine{\Hypertarget{mesh_8cpp_source_l00772}00772     \textcolor{keywordflow}{if} (m\_mesh != \textcolor{keyword}{nullptr})}
\DoxyCodeLine{\Hypertarget{mesh_8cpp_source_l00773}00773     \{}
\DoxyCodeLine{\Hypertarget{mesh_8cpp_source_l00774}00774         renderStats.meshBytes -\/= m\_mesh-\/>getDataSize();}
\DoxyCodeLine{\Hypertarget{mesh_8cpp_source_l00775}00775         m\_mesh-\/>update(std::move(m\_attributesFloat), std::move(m\_attributesVec2), std::move(m\_attributesVec3), std::move(m\_attributesVec4), std::move(m\_attributesIVec4), std::move(m\_indices), m\_topologies, m\_bufferUsage, m\_name, renderStats);}
\DoxyCodeLine{\Hypertarget{mesh_8cpp_source_l00776}00776         \textcolor{keywordflow}{return} m\_mesh-\/>shared\_from\_this();}
...
\DoxyCodeLine{\Hypertarget{mesh_8cpp_source_l00785}00785     \textcolor{keywordflow}{if} (m\_mesh != \textcolor{keyword}{nullptr} \&\& m\_attributesFloat.find(name.data()) == m\_attributesFloat.end())}
...
\DoxyCodeLine{\Hypertarget{mesh_8cpp_source_l00798}00798     \textcolor{keywordflow}{if} (m\_mesh != \textcolor{keyword}{nullptr} \&\& m\_attributesVec2.find(name.data()) == m\_attributesVec2.end())}
...
\DoxyCodeLine{\Hypertarget{mesh_8cpp_source_l00811}00811     \textcolor{keywordflow}{if} (m\_mesh != \textcolor{keyword}{nullptr} \&\& m\_attributesVec3.find(name.data()) == m\_attributesVec3.end())}
...
\DoxyCodeLine{\Hypertarget{mesh_8cpp_source_l00824}00824     \textcolor{keywordflow}{if} (m\_mesh != \textcolor{keyword}{nullptr} \&\& m\_attributesVec4.find(name.data()) == m\_attributesVec4.end())}
...
\DoxyCodeLine{\Hypertarget{mesh_8cpp_source_l01120}01120     \textcolor{keywordflow}{if} (m\_mesh != \textcolor{keyword}{nullptr} \&\& m\_attributesIVec4.find(name.data()) == m\_attributesIVec4.end())}
...
\DoxyCodeLine{\Hypertarget{mesh_8cpp_source_l01187}01187 \} \textcolor{comment}{// namespace ceres}}
