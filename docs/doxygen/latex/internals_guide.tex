...
The internal interface is in charge of GLFW\textquotesingle{}s global data, which it stores in a {\ttfamily \mbox{\hyperlink{struct___g_l_f_wlibrary}{\+\_\+\+GLFWlibrary}}} struct named {\ttfamily \+\_\+glfw}.

The internal interface uses the same style as the public interface, except all global names have a leading underscore.

Examples\+: {\ttfamily \+\_\+glfw\+Is\+Valid\+Context\+Config}, {\ttfamily \mbox{\hyperlink{struct___g_l_f_wwindow}{\+\_\+\+GLFWwindow}}}, {\ttfamily \+\_\+glfw.\+monitor\+Count}\hypertarget{internals_guide_internals_platform}{}\doxysection{Platform interface}\label{internals_guide_internals_platform}
...
Examples\+: {\ttfamily \mbox{\hyperlink{struct___g_l_f_wwindow_x11}{\+\_\+\+GLFWwindow\+X11}}}, {\ttfamily \mbox{\hyperlink{struct___g_l_f_wcontext_w_g_l}{\+\_\+\+GLFWcontext\+WGL}}}
