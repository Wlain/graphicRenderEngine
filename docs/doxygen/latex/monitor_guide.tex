This guide introduces the monitor related functions of GLFW. For details on a specific function in this category, see the \mbox{\hyperlink{group__monitor}{Monitor reference}}. There are also guides for the other areas of GLFW.
...
Video modes are represented as \mbox{\hyperlink{struct_g_l_f_wvidmode}{GLFWvidmode}} structures. You can get an array of the video modes supported by a monitor with \mbox{\hyperlink{group__monitor_ga7eaea6132f15e9b5d47eb94f88547f79}{glfw\+Get\+Video\+Modes}}. See the reference documentation for the lifetime of the returned array.
...
To get the current video mode of a monitor call \mbox{\hyperlink{group__monitor_ga21f7f60de4f4d0fa360c7ad159b75c9e}{glfw\+Get\+Video\+Mode}}. See the reference documentation for the lifetime of the returned pointer.
...
The human-\/readable, UTF-\/8 encoded name of a monitor is returned by \mbox{\hyperlink{group__monitor_ga6d0ee079c807cd123b56dc3fc01e8fd9}{glfw\+Get\+Monitor\+Name}}. See the reference documentation for the lifetime of the returned string.
...
Each monitor has a user pointer that can be set with \mbox{\hyperlink{group__monitor_ga6d89c74c1c293f0ab78a00c3c6d1ae44}{glfw\+Set\+Monitor\+User\+Pointer}} and queried with \mbox{\hyperlink{group__monitor_ga13cb11e8f507dbc477e10a040f0fad7f}{glfw\+Get\+Monitor\+User\+Pointer}}. This can be used for any purpose you need and will not be modified by GLFW. The value will be kept until the monitor is disconnected or until the library is terminated.
...
The gamma ramp of a monitor can be set with \mbox{\hyperlink{group__monitor_gac9f36a1cfa10eab191d3029ea8bc9558}{glfw\+Set\+Gamma\+Ramp}}, which accepts a monitor handle and a pointer to a \mbox{\hyperlink{struct_g_l_f_wgammaramp}{GLFWgammaramp}} structure.
...
The current gamma ramp for a monitor is returned by \mbox{\hyperlink{group__monitor_gafe7b41852c1a14fe978f0e5381969885}{glfw\+Get\+Gamma\+Ramp}}. See the reference documentation for the lifetime of the returned structure.
...
If you wish to set a regular gamma ramp, you can have GLFW calculate it for you from the desired exponent with \mbox{\hyperlink{group__monitor_ga3e4ab484476c935b4cd0bf49a5c429d6}{glfw\+Set\+Gamma}}, which in turn calls \mbox{\hyperlink{group__monitor_gac9f36a1cfa10eab191d3029ea8bc9558}{glfw\+Set\+Gamma\+Ramp}} with the resulting ramp.
