This guide introduces the Open\+GL and Open\+GL ES context related functions of GLFW. For details on a specific function in this category, see the \mbox{\hyperlink{group__context}{Context reference}}. There are also guides for the other areas of the GLFW API.
...
GLFW comes with a barebones object sharing example program called {\ttfamily sharing}.\hypertarget{context_guide_context_offscreen}{}\doxysubsection{Offscreen contexts}\label{context_guide_context_offscreen}
...
The following GLFW functions require a context to be current. Calling any these functions without a current context will generate a \mbox{\hyperlink{group__errors_gaa8290386e9528ccb9e42a3a4e16fc0d0}{GLFW\+\_\+\+NO\+\_\+\+CURRENT\+\_\+\+CONTEXT}} error.
...
\begin{DoxyItemize}
\item An extension name (e.\+g. {\ttfamily GL\+\_\+\+ARB\+\_\+debug\+\_\+output})
\item New Open\+GL tokens (e.\+g. {\ttfamily GL\+\_\+\+DEBUG\+\_\+\+SEVERITY\+\_\+\+HIGH\+\_\+\+ARB})
\item New Open\+GL functions (e.\+g. {\ttfamily gl\+Get\+Debug\+Message\+Log\+ARB})
\end{DoxyItemize}
...
The argument is a null terminated ASCII string with the extension name. If the extension is supported, \mbox{\hyperlink{group__context_ga9a28c712d35f9e43534e1d03b051c04c}{glfw\+Extension\+Supported}} returns {\ttfamily GLFW\+\_\+\+TRUE}, otherwise it returns {\ttfamily GLFW\+\_\+\+FALSE}.\hypertarget{context_guide_context_glext_proc}{}\doxysubsubsection{Fetching function pointers}\label{context_guide_context_glext_proc}
