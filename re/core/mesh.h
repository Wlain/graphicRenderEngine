...
public:
    ...
    private:
        ...
        std::vector<BufferUsage> m_bufferUsage;
        std::string m_name;
...
public:
    ...
    BufferUsage getMeshBufferUsage(int indexSet = 0);
    template <typename T>
...
private:
    ...
    Mesh(std::map<std::string, std::vector<float>>&& attributesFloat, std::map<std::string, std::vector<glm::vec2>>&& attributesVec2, std::map<std::string, std::vector<glm::vec3>>&& attributesVec3, std::map<std::string, std::vector<glm::vec4>>&& attributesVec4,
         std::map<std::string, std::vector<glm::i32vec4>>&& attributesIVec4, std::vector<std::vector<uint16_t>>&& indices, std::vector<Topology>& meshTopology, std::vector<BufferUsage>& bufferUsage, std::string_view name, RenderStats& renderStats);
